...
loadParticipants();
  ...
  useEffect(() => {
    ...
    eventsApi.get(id).then((e) => {
      ...
      setTitle(e.title);
      const rawType = e.type || 'face-to-face';
      const mappedType = rawType === 'meeting' || rawType === 'event' ? 'face-to-face' : rawType === 'zoom' ? 'virtual' : TYPES.some((t) => t.value === rawType) ? rawType : 'face-to-face';
      setType(mappedType);
      setDate(e.date);
      setEndDate(e.date);
