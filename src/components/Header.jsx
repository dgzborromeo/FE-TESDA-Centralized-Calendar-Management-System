      ...
      <div className="header-inner">
        <div className="header-left">
          <Link to="/dashboard" className="header-logo">
            ...
            <span className="header-logo-text"><span className="header-logo-accent">O</span>perations <span className="header-logo-accent">N</span>etwork and <span className="header-logo-accent">E</span>vents <span className="header-logo-accent">S</span>ystem</span>
          </Link>
          {isCalendarPage && (
            <input
              type="search"
